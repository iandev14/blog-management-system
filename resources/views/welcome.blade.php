...
@section('content')
    <div class="container min-h-screen bg-[url('assets/images/background.jpg')] bg-center bg-cover px-28 py-5">
        <div class="text-white mt-20 max-w-xl">
            ...
            <h2 class="text-5xl font-semibold leading-normal"><span class="font-light">Easily manage and profit from your
                    content.</span></h2>
        ...
        <img src="{{ asset('assets/images/person-with-laptop.png') }}"
            class="w-7/12 xl:w-5/12 xl:absolute bottom-0 right-10 object-cover">
    </div>
@endsection
