...
@section('content')
    <div
        class="flex justify-center items-center min-h-screen bg-[url('assets/images/background.jpg')] bg-center bg-cover px-28 py-5">
        <div class="w-full max-w-md bg-white p-8 rounded-lg shadow-lg">
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <!-- Password Input -->
                <x-input id="password" label="Password" type="password" name="password"
            ...
            <p class="mt-6 text-center text-sm text-gray-600">
                Don't have an account? <a href="{{ route('register') }}" class="text-gray-800 hover:underline">Sign up</a>
            </p>
        </div>
    </div>
@endsection
